"""Regression checks for the meridian-sys-lock-index casebook."""
...
from casebook.harness import assert_expected, meridian_sys_lock_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_sys_lock_index_summary(), assert_expected())
